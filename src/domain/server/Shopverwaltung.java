...
public class Shopverwaltung implements Serializable{
	...
	/** �ndert den bestand des artikels mit der artikelnummer "artklnummer"
	 * 
	 * @param artklnummer artikelnummer des zu ver�ndernden Artikels
	 * @param newBestand1 neuer bestand
	 * @return ge�nderte artikel
	 * @throws ArtikelExistiertNichtException
	 */
	...
	/** �ndert die Daten eines Artikels
	 * 
	 * @param artikelname
	 * @param artikelnummer
	 * @param bestand
